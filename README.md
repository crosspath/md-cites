...
I need to write and edit my dissertation splitting it onto several Markdown files and use GOST R 7.0.5-2008 (√Œ—“ – 7.0.5ó2008), Russian citation format.
...
<ol>
  <li><a name="a-knuth"></a> Knuth D. The Art of Computer Programming, 1: Fundamental Algorithms (3rd ed.). ó USA: Addison-Wesley Professional, 1997. ó ISBN 0-201-89683-4.</li>
</ol>
```
